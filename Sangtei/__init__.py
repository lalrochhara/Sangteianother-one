...
log.info("[Sangtei] Sangtei is starting. | An Eagle Union Project. | Licensed under GPLv3.")
log.info("[Sangtei] Not affiliated to Azur Lane or Yostar in any way whatsoever.")
log.info("[Sangtei] Project maintained by: github.com/lalrochhara (t.me/NickyLrca)")
...
class SangteiINIT:
    def __init__(self, parser: ConfigParser):
        ...
        self.bot_name = "Sangtei" #placeholder
        self.bot_username = "Sangtei" #placeholder
...
KInit = SangteiINIT(parser=kigconfig)
