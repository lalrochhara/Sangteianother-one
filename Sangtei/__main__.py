...
from Sangtei.modules.helper_funcs.decorators import kigcmd, kigcallback, kigmsg
            ...
            if args[0].lower() == "help":
                ...
                help_buttons.append(
                    [InlineKeyboardButton(text="Back", callback_data="help_back"),
                     InlineKeyboardButton(text='Support', url='https://t.me/SangteiSupport')]
                )
                send_help(
                    chat.id,
                    text,
...
def help_button(update: Update, context: CallbackContext):
    ...
    try:
        if mod_match:
            ...
            # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/SangteiSupport'),
            #           InlineKeyboardButton(text='Back', callback_data='start_back'),
            #           InlineKeyboardButton(text="Try inline", switch_inline_query_current_chat="")])
            query.message.edit_text(
                text=gs(chat.id, "pm_help_text"),
...
def main():
    ...
    if WEBHOOK:
        ...
        log.info(f"Sangtei started, Using webhooks. | BOT: [@{dispatcher.bot.username}]")
