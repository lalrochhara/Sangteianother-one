...
from Sangtei.modules.helper_funcs.misc import article
from Sangtei.modules.helper_funcs.decorators import kiginline
...
def inlinequery(update: Update, _) -> None:
    ...
    if (f := query.split(" ", 1)[0]) in inline_funcs:
        ...
        inline_help_dicts = [
            ...
            #},
            {
                "title": "Account info on Sangtei",
                "description": "Look up a Telegram account in Sangtei database",
                "message_text": "Click the button below to look up a person in Sangtei database using their Telegram ID",
                "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
                "keyboard": ".info ",
            },
            {
                "title": "About",
                "description": "Know about Sangtei",
                "message_text": "Click the button below to get to know about Sangtei.",
                "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
                "keyboard": ".about ",
            },
            {
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About Sangtei (@{context.bot.username})",
