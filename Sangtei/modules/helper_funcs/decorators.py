...
kigcmd = SangteiTelegramHandler(d).command
kigmsg = SangteiTelegramHandler(d).message
kigcallback = SangteiTelegramHandler(d).callbackquery
kiginline = SangteiTelegramHandler(d).inlinequery
