...
from Sangtei.modules.helper_funcs.decorators import kigcmd, kigcallback
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(status +
            ...
            "\n\n[⍙ GitHub](https://github.com/lalrochhara/Sangtei) | [⍚ GitLab](https://gitlab.com/lalrochhara/Sangtei)\n\n" +
